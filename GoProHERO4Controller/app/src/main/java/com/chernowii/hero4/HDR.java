...
public class HDR extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_hdr, menu);
        return true;
    }
    ...
    public void sendHDROne (View view){
        try {
            Thread.sleep(100);
        ...
        Toast.makeText(getApplicationContext(),
                "First picture taken!", Toast.LENGTH_SHORT).show();
      try {
            Thread.sleep(1900);
        } catch (InterruptedException e) {
            e.printStackTrace();
        ...
        new HttpAsyncTask().execute("http://10.5.5.9/gp/gpControl/command/shutter?p=1");
        Toast.makeText(getApplicationContext(),
                "Second picture taken!", Toast.LENGTH_SHORT).show();
        try {
            Thread.sleep(1900);
        } catch (InterruptedException e) {
            e.printStackTrace();
        ...
        new HttpAsyncTask().execute("http://10.5.5.9/gp/gpControl/command/shutter?p=1");
        Toast.makeText(getApplicationContext(),
                "Third picture taken!", Toast.LENGTH_SHORT).show();
        try {
            Thread.sleep(3000);
        } catch (InterruptedException e) {
            e.printStackTrace();
        ...
        v.vibrate(600);
        Toast.makeText(getApplicationContext(),
                "HDR FINISHED!", Toast.LENGTH_LONG).show();
    }
    public void sendHDRTwo (View view){
        try {
            Thread.sleep(100);
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    public void sendHDRThree (View view){
        try {
            Thread.sleep(100);
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    public void sendHDRFour (View view){
        try {
            Thread.sleep(100);
        } catch (InterruptedException e) {
            e.printStackTrace();
